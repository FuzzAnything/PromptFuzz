...
def analyze_log_directory(directory_path):
    # Match: Prompt: 123, Completion: 456, Total: 789
    ...
    print(f"{'FileName':<30} | {'Prompt':>10} | {'Completion':>10} | {'Total':>10}")
    print("-" * 70)
    ...
    print("-" * 70)
    print(f"{'FileName':<30} | {grand_total_prompt:>10,} | {grand_total_completion:>10,} | {grand_total_tokens:>10,}")
